...
public class MaskAssignmentForm extends JPanel {
	...
	private JPanel getPanel() {
		if (panel == null) {
			...
			gbl_panel.rowHeights = new int[]{51, 16, 35, 34, 16, 25, 48, 35, 0};
			...
			gbc_chckbxHabilitarNota.fill = GridBagConstraints.VERTICAL;
			gbc_chckbxHabilitarNota.insets = new Insets(0, 0, 5, 5);
			gbc_chckbxHabilitarNota.gridx = 2;
			gbc_chckbxHabilitarNota.gridy = 5;
